module.exports = function(){
  StructureSpawn.prototype.createBuilder =
    function(energy,roleName){
      ...
      return this.createCreep(body, undefined, {role: roleName, building: false, homeRoom: this.room.name });
    };
    ...
    StructureSpawn.prototype.createUpgrader =
      function(energy,roleName){
        ...
        return this.createCreep(body, undefined, {role: roleName, upgrading: false, homeRoom: this.room.name });
      };
    ...
    //Get the count of the number of containers and storage.  If none do not make movers
      function(energy,roleName){
        ...
        return this.createCreep(body, undefined,{role: roleName,  homeRoom: this.room.name});
      };
